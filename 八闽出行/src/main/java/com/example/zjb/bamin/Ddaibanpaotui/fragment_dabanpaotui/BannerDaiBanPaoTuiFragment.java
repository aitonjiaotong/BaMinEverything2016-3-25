...
public class BannerDaiBanPaoTuiFragment extends Fragment
{
    ...
    public BannerDaiBanPaoTuiFragment()
    {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public BannerDaiBanPaoTuiFragment(int pager_index, String imageUrl, String redpacketUrl)
    {
    ...
    @SuppressLint("ValidFragment")
    public BannerDaiBanPaoTuiFragment(int pager_index, int imageId)
    {
        this.mPosition = pager_index;
